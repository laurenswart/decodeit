...
"use strict";
/*!******************************************************!*\
  !*** ./resources/js/teacherStudentAssignmentShow.js ***!
  \******************************************************/
...
window.onload = function () {
  //editable final url
  document.querySelectorAll(".updateFeedback > div > button").forEach(function (btn) {
    btn.addEventListener('click', function () {
      var outerDiv = this.closest('.updateFeedback');
      var p = outerDiv.querySelector('p');
      var currentText = p.innerText;
      var textarea = document.createElement('TEXTAREA');
      textarea.innerText = currentText;
      textarea.setAttribute('rows', 3); //textarea.setAttribute('cols', 150);
