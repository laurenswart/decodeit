...
<head>
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
      <div class="offcanvas-header">
          ...
          <button type="button" class="btn-close text-reset" style="color:black" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div class="offcanvas-body">
          <div class="dropdown mt-3">
              <ul >
                <li><a  href="{{ route('teacherDashboard') }}">Dashboard</a></li>
                <li><a  href="{{ route('course_teacherIndex')}}">Courses</a></li>
                <li><a  href="{{ route('student_teacherIndex') }}">Students</a></li>
                <li><a  href="{{ route('teacher_account') }}">My Account</a></li>
                <li>
                    <!-- Authentication -->
                    <form method="POST" action="{{ route('logout') }}" class="mb-0">
                        @csrf
