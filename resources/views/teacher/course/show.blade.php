...
<section>
		...
		<a href="{{ route('chapter_teacherShow', $chapter->chapter_id)}}" class="listElement-h light-card row zoom">
	...
	<section id="coming-up">
		...
		<a href="{{ route('assignment_teacherShow', $assignment->assignment_id)}}" class="listElement-h light-card row zoom">
