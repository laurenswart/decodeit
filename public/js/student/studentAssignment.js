...
function sendSubmission(_x) {
  return _sendSubmission.apply(this, arguments);
}

function _sendSubmission() {
  _sendSubmission = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(options) {
...
function getSubmissionResponse(_x2) {
  return _getSubmissionResponse.apply(this, arguments);
}

function _getSubmissionResponse() {
  _getSubmissionResponse = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(token) {
    var options;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return fetch("https://ce.judge0.com/submissions/" + token + "?fields=stdout,stderr,status_id,language_id", options).then(function (response) {
              if (!response.ok) {
                throw new Error("HTTP error! status: ".concat(response.status));
              }
...
window.addQuestion = function (button) {
  var questionDiv = button.closest('.submissionQuestion');
  var questionContent = questionDiv.querySelector('textarea').value;
  var submissionId = button.dataset.submissionid; //if question empty do nothing
  ...
  xhr.onload = function () {
    ...
    if (this.status === 200) {
      ...
      if (_data2.success) {
        ...
        questionDiv.parentNode.insertBefore(p, questionDiv); //change h4 content
